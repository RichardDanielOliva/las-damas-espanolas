...
> Nota: en la version 1.0 no es posible comer mas de una ficha por turno.
#### 3. Movimiento de las damas:
...
#### 4. La partida acaba en los siguientes casos:
> 4.1 Cuando algun jugador se quede sin peones o damas

> 4.2 Cuando cada jugador haya efectuado 20 movimientos de dama(s) sin que ninguno de los bandos haya efectuado un movimiento de peón, captura o entrega de pieza se decretará tablas.
